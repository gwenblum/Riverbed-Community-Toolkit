...
6. Enable Auto-Instrumentation in a namespace
7. Deploy a workload
...
To finf the external ip address, run the following command. It can take few minutes before the EXTERNAL-IP is assigned and get displayed.
